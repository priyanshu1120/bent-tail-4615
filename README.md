# Collaborative Project At Masai School “MyTv+” Aspiring from "AppleTv+" .
...
# Project Details 
MyTv+ is the website for watching Movies and shows. its have a subscription functionality and high security authentication with firebase for the users and admin both and we can se diffrent type of category in movies and shows.
