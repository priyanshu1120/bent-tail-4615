...
import {Flex,Box,FormControl,FormLabel,Input,InputGroup,HStack,InputRightElement,Stack,Button,Heading,Text,useColorModeValue,Center,Spinner,
...
export const SignupAdmin =()=> {
  ...
  return (
    ...
    <Flex backdropBlur={50} minH={'50vh'}align={'center'} justify={'center'}>
          ...
          <form>
            ...
            <FormControl id="Confirm password" isRequired>
              ...
              <InputGroup>
                ...
                <InputRightElement h={'full'}>
                  <Button variant={'ghost'} onClick={() => setconfirmShowPassword((confirmshowPassword) => !confirmshowPassword) }>
            ...
            <Stack pt={5} spacing={6} direction={['column', 'row']}>
              <Box>
                <Link to={"/"}>
                  <Button color={'white'}w="full"  _hover={{ bg: 'red.500'}}>
                    Cancel
                  </Button>
                </Link>
              </Box>
              <Button bg={'blue.400'} color={'white'} w="full" _hover={{ bg: 'blue.500' }}type="submit"  onClick={handleSubmit} >
                Sign Up
              </Button>
            </Stack>
          </form>
            ...
            <Center px={8}>
              <Button  w={'full'}maxW={'md'}variant={'outline'} leftIcon={<FcGoogle />} onClick={handleGoogleSignIn}>
                <Center>
            ...
            <HStack justifyContent={"center"} pt={2}>
              <Text align={'center'}> Already Register with us?</Text>
              <Link to="/login" >
                <Text align={'center'} color={'blue.400'}>Login</Text>
              </Link>
            </HStack>
          </Stack>
        </Box>
