  ...
  return (
    <div>
      ...
      <Box mt={"50px"}>
        ...
        <CommonSlider url={`${base}/futureRelease`} />
      </Box>
     ...
     <Box mt="60px">
      ...
      <Box mt="15px">
        ...
        <CommonSlider url={`${base}/funForAll`} />
      </Box>
